...
using_model_serializer_paths = [
    path("using-model-serializer/student", views.StudentUsingModelSerializerView.as_view())
]
...
generic_urls = [
  ...
  path("generic/classroom-delete/<int:pk>/", views.ClassRoomGenericDestroyView.as_view()),
]
