...
def detail_student(request, id):
    ...
    return render(request, template_name="crud/detail_student.html", context={"student": s, "classrooms": ClassRoom.objects.all() })
...
def update_student(request, id):
    ...
    if request.method == "POST":
        ...
        sp, created = StudentProfile.objects.update_or_create(student=s,
